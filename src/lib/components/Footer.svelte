...
<footer class="text-white flex flex-col gap-2 justify-center items-center py-4">
	<span class="text-lg">Got any questions or feedback? We would love to hear from you!</span>
