	...
	<section class="md:mt-36 mt-20 flex md:flex-row flex-col md:gap-24 gap-8">
		...
		<section class="flex flex-col gap-4 md:w-[75%]">
			...
			<div class="text-xl w-fit flex flex-col gap-2">
				<span>
					IEEE Computer Society is one of VIT Chennai's active and recognized technical clubs. We
				...
				<span>
					We will teach you the skills that are needed to build and deliver products from scratch
